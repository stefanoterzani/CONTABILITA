...
const InputPaginaSingola = ({formNumber,schema,top,altezzaScroll,larghezzaScroll,barra,barraInserisciElimina,placeholder,etichetta,handleFocus,handleAggiungiPagina,handleEliminaPagina}) => {
