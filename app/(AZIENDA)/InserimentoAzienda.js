...
const [key, setKey] = useState(1);
 ...
 useEffect(() => {
  ...
  const nuovoOrganizzato1=inizializzaSchemaFormPaginaMultipla(
    0,    // Numero Schema
    schemaCliente,setSchema_1, // Schema e funzione per settare lo schema
...
formMethods.setValue("0.codicefiscale","TRZSFN51P16H501V");
 ...
 // setClientiData([]); // Resetta lo stato dei dati dei clienti
  ...
  return (
    <SafeAreaView style={{flex:1}}>
        ...
        <Header windowWidth={standardWindowWidth} headerHeight={standardHeaderHeight} titolo='Inserimento Azienda'/>
        ...
        <View style={stileContenitoreBottoniSubmit}>
          ...
          <TouchableOpacity style={getStileBottoniSubmit(2)}
             ...
             // onPress={()=> handleEvent('reset','form1')}
              ...
              onPress={resetCache}
              > 
              <Text style={getStileTestoBottoniSubmit(2)}> RESET CACHE</Text>     
          </TouchableOpacity>
