const schemaCliente = {
    ...
    pec: { label: 'Pec', type: 'email', obbligatorio:false, visibile:true ,
     ...
     codiceAteco: { label: 'ATECO', type: 'text' , obbligatorio:false, visibile:true ,
      layout: { 
        web: { row: 5, margineDx:'2%' , visibile: true, width:'15%'}, 
        mobile: { row: 9, margineDx: 0 , visibile: true, width:'100%'} } 
        },

     riferimento: { label: 'Persona', type: 'text' , obbligatorio:false, visibile:true ,
      layout: { 
        web: { row: 5, margineDx:'2%', visibile: true, width:'35%'}, 
        mobile: { row: 9, margineDx: 0 , visibile: true, width:'100%'} } 
        },
            
     telefono_1: { label: 'Telefono', type: 'text' , obbligatorio:false, visibile:true ,
        layout: { 
          web: { row:5, margineDx:'2%',visibile: true, width:'20%'}, 
