const schemaAzienda = {
    ...
    nome: { label: 'Nome Azienda', type: 'text', obbligatorio:true,visibile:true,
      layout: { 
    ...
    email: { label: 'E-mail', type: 'email' , obbligatorio:false, visibile:true,
      ...
      dataCostituzione: { label: 'Costituzione (gg/mm/aaaa)', type: 'date', obbligatorio:false, visibile:true,
      layout: { 
        web: { row: 5, margineDx: '1%' , visibile: true, width:'26%'}, 
        mobile: { row: 6, margineDx: 0 ,visibile: true, width:'100%'} } 
      },


    tribunale: { label: 'Tribunale', type: 'text', obbligatorio:false, visibile:true,
      layout: { 
        web: { row: 5, margineDx: '1%' , visibile: true, width:'25%'}, 
        mobile: { row: 7, margineDx: 0 ,visibile: true, width:'100%'} } 
      },

   
      cciaa: { label: 'CCIAA', type: 'text', obbligatorio:false, visibile:true,
      layout: { 
        web: { row: 5, margineDx: '1%' , visibile: true, width:'25%'}, 
        mobile: { row: 8, margineDx: 0 ,visibile: true, width:'100%'} } 
        },
    ...
    logo: { label: 'Logo', type: 'date', obbligatorio:false, visibile:false,
      layout: { 
        web: { row: 5, margineDx: 0 , visibile: false, width:'30%'}, 
        mobile: { row: 6, margineDx: 0 ,visibile: false, width:'45%'} } 
      },
      aziendaId: { label: 'Id', type: 'text', obbligatorio:false, visibile:false,
        layout: { 
          web: { row: 5, margineDx: 0 , visibile: false, width:'30%'}, 
          mobile: { row: 6, margineDx: 0 ,visibile: false, width:'45%'} } 
        },
      adminId: { label: 'Id', type: 'text', obbligatorio:false, visibile:false,
        layout: { 
          web: { row: 5, margineDx: 0 , visibile: false, width:'30%'}, 
          mobile: { row: 6, margineDx: 0 ,visibile: false, width:'45%'} } 
        },
    ...
    sedeLegale: {
      citta: { label: 'Città', type: 'text'  , obbligatorio:false, visibile:true,
        ...
        layout: { 
         ...
         provincia: { label: 'Provincia', type: 'text'  , obbligatorio:false, visibile:true,
          layout: { 
            web: { row: 3, margineDx:'2%', visibile: true, width:'70%' }, 
            mobile: { row: 7, margineDx:'3%', visibile: true, width:'67%'} 
          } },  

        cap: { label: 'CAP', type: 'text' , obbligatorio:false , visibile:true,
          layout: { 
            web: { row: 3, margineDx:  '2%' ,visibile: true, width:'25%'}, 
            mobile: { row:7, margineDx: 0, visibile: true, width:'30%' } 
          } },

        nazione: { label: 'Nazione', type: 'text' , obbligatorio:false, visibile:true,
         layout: { 
  ...
  const schemaUnitaOperativa={
    indirizzo: { label: 'Indirizzo', type: 'text' , obbligatorio:false, 
      layout: { 
        web: { row:1, margineDx: 0 , visibile: true, width:'100%'}, 
        mobile: { row: 5, margineDx: 0 , visibile: true, width:'100%'}
       } },
    
    citta: { label: 'Città', type: 'text'  , obbligatorio:false, 
      layout: { 
        web: { row: 2, margineDx: '2%' , visibile: true, width:'75%'}, 
        mobile: { row: 6, margineDx: 10 , visibile: true, width:'75%'} 
      } },

    cap: { label: 'CAP', type: 'text' , obbligatorio:false , 
      layout: { 
        web: { row: 2, margineDx:  '2%' ,visibile: true, width:'20%'}, 
        mobile: { row:6, margineDx: 0, visibile: true, width:'22%' } 
        } },

    provincia: { label: 'Provincia', type: 'text'  , obbligatorio:false, 
      layout: { 
        web: { row: 3, margineDx:'2%', visibile: true, width:'40%' }, 
        mobile: { row: 7, margineDx: 0 , visibile: true, width:'100%'} 
      } },
   
    nazione: { label: 'Nazione', type: 'text' , obbligatorio:false, 
      layout: { 
        web: { row:3, margineDx:'2%',visibile: true, width:'55%'}, 
        mobile: { row:8, margineDx: '2%' , visibile: true, width:'100%'} 
      } },
      telefono_1: { label: 'Telefono 1', type: 'text' , obbligatorio:false, 
        layout: { 
          web: { row:4, margineDx:'2%',visibile: true, width:'31%'}, 
          mobile: { row:9, margineDx: '5%' , visibile: true, width:'47%'} 
        } },
      telefono_2: { label: 'Telefono 2', type: 'text' , obbligatorio:false, 
        layout: { 
          web: { row:4, margineDx: '2%',visibile: true, width:'31%'}, 
          mobile: { row:9, margineDx: 0 , visibile: true, width:'47%'} 
        } },
      fax: { label: 'Fax', type: 'text' , obbligatorio:false, 
        layout: { 
          web: { row:4, margineDx: 0 ,visibile: true, width:'31%'}, 
          mobile: { row:10, margineDx: 0 , visibile: true, width:'47%'} 
        } },  

  }

  const schemaSedeLogistica={
      indirizzo: { label: 'Indirizzo', type: 'text' , obbligatorio:false, 
        layout: { 
          web: { row:1, margineDx: 0 , visibile: true, width:'100%',visibile:false}, 
          mobile: { row: 5, margineDx: 0 , visibile: true, width:'100%'}
         } },
  ...
  export  {schemaAzienda,schemaUnitaOperativa,schemaSedeLogistica}